class TicketsController < ApplicationController
  ...
  before_filter :load_ticketable, only: [:show, :new, :edit, :create, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @ticket.save
        format.html { redirect_to @ticketable, notice: 'Ticket was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ticket.update(ticket_params)
        format.html { redirect_to @ticketable, notice: 'Ticket was successfully updated.' }
